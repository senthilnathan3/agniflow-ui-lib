...
import blue from '@agniflow-ui/panda-preset/colors/blue'
import bronze from '@agniflow-ui/panda-preset/colors/bronze'
import brown from '@agniflow-ui/panda-preset/colors/brown'
import crimson from '@agniflow-ui/panda-preset/colors/crimson'
import cyan from '@agniflow-ui/panda-preset/colors/cyan'
import gold from '@agniflow-ui/panda-preset/colors/gold'
import grass from '@agniflow-ui/panda-preset/colors/grass'
import green from '@agniflow-ui/panda-preset/colors/green'
import indigo from '@agniflow-ui/panda-preset/colors/indigo'
import iris from '@agniflow-ui/panda-preset/colors/iris'
import jade from '@agniflow-ui/panda-preset/colors/jade'
import lime from '@agniflow-ui/panda-preset/colors/lime'
import mauve from '@agniflow-ui/panda-preset/colors/mauve'
import mint from '@agniflow-ui/panda-preset/colors/mint'
import neutral from '@agniflow-ui/panda-preset/colors/neutral'
import olive from '@agniflow-ui/panda-preset/colors/olive'
import orange from '@agniflow-ui/panda-preset/colors/orange'
import pink from '@agniflow-ui/panda-preset/colors/pink'
import plum from '@agniflow-ui/panda-preset/colors/plum'
import purple from '@agniflow-ui/panda-preset/colors/purple'
import red from '@agniflow-ui/panda-preset/colors/red'
import ruby from '@agniflow-ui/panda-preset/colors/ruby'
import sage from '@agniflow-ui/panda-preset/colors/sage'
import sand from '@agniflow-ui/panda-preset/colors/sand'
import sky from '@agniflow-ui/panda-preset/colors/sky'
import slate from '@agniflow-ui/panda-preset/colors/slate'
import teal from '@agniflow-ui/panda-preset/colors/teal'
import tomato from '@agniflow-ui/panda-preset/colors/tomato'
import violet from '@agniflow-ui/panda-preset/colors/violet'
import yellow from '@agniflow-ui/panda-preset/colors/yellow'
