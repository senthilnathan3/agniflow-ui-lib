...
id: customize
title: Customize
description: Learn how to customize the Agniflow UI Preset
---

This guide will walk you through the different ways you can customize Agniflow UI to fit your brand.

## Presets

Agniflow UI was built with customization in mind. By adding the `@agniflow-ui/panda-preset` into your Panda configuration,
...
> Since **Agniflow UI** uses [Radix Colors](https://www.radix-ui.com/colors) under the hood, you can use their [tool](https://www.radix-ui.com/colors/custom) to generate your custom color palette.
...
import { defineConfig } from '@pandacss/dev'
import { createPreset } from '@agniflow-ui/panda-preset'
import { createPreset } from '@agniflow-ui/panda-preset/colors/sand'
...
A powerful way to customize Agniflow UI is by adjusting
[semantic tokens](https://agniflow-ui.com/docs/panda/theme/semantic-tokens). This is helpful if you want to modify specific
...
As of `v0.44`, the `@agniflow-ui/panda-preset` no longer includes component recipes.
