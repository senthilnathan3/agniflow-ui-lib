...
description: Bring the Agniflow UI semantic to your entire application
---

## Colors

Agniflow UI's theme primarily revolves around one gray and one accent color. These foundational colors are later utilized to
...
// live
<Box bg="bg.muted" p="2">
  <Text size="sm">Hello from Agniflow UI</Text>
</Box>
```
