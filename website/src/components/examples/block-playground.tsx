            ...
            <Tooltip.Root positioning={{ placement: 'top' }} openDelay={0}>
              <Tooltip.Trigger asChild>
                <IconButton variant="outline" asChild>
                  <a
                    href={`https://www.figma.com/design/wN70u2btZ6uKVxFJ8UPXvy/Agniflow-UI-Design-System-Pro-Components-(Preview)?node-id=${block.figmaNodeId}&mode=design`}
                    target="_blank"
                    rel="noreferrer"
                  >
                    <FigmaIcon />
