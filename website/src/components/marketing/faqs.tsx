...
export const Faqs = () => {
  const questions = [
    {
      question: 'What do I get when I purchase Agniflow Plus?',
      answer: (
        <Text>
    ...
    },
    {
      ...
      answer: (
        <Text>
          ...
          version of Agniflow UI for the best experience.
        </Text>
      ),
    },
    {
      ...
      answer: (
        <Text>
          ...
          on our{' '}
          <Link
            href="https://github.com/ssenthilnathan3/agniflow-ui/issues/new"
            target="_blank"
    ...
    <Stack gap={{ base: '12', lg: '24' }} direction={{ base: 'column', lg: 'row' }} width="full">
      <Stack gap={{ base: '4', md: '5' }} maxW={{ lg: 'md' }}>
        ...
        <Text color="fg.muted" textStyle="lg">
          Everything you need to know about Agniflow UI Plus. For questions about licensing, please see
          our{' '}
          <Link asChild>
